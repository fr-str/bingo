...
SELECT id, field, is_set, session, created_at, updated_at FROM bingo_history WHERE id = ?1
`

func (q *Queries) GetEntry(ctx context.Context, id string) (BingoHistory, error) {
